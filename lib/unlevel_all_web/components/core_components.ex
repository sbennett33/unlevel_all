defmodule UnlevelAllWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UnlevelAllWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UnlevelAllWeb.Gettext, "errors", msg, opts)
    end
  end
